...
var YoukuAuth = (function () {
    ...
    _createClass(YoukuAuth, [{
        ...
        value: function get_access_token(type, payload, callback) {
            ...
            _cuddle2.default.post.to(this.ACCESS_TOKEN_URL).send(params).then(this.save_access_token.bind(this, callback));
        }
    }, {
        ...
        key: 'upload',
        value: function upload(metadata, filepath, callback, check_progress) {
            var _this = this;
